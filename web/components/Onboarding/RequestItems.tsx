...
export default function RequestItemsPage({
  ...
  return (
    <div className="h-screen w-full flex flex-grow flex-col items-start justify-between p-10 overriden">
      ...
      <div className="absolute w-[calc(100%-100px)] flex flex-col items-center">
          <h1 className="text-2xl font-bold text-center flex flex-row items-center justify-center leading-[33px] py-[10px]">Request Items</h1>
          <p className="font-normal text-[#000000] text-[16px] leading-[22px] py-[10px]">Motherhood Beyond Bars will deliver you supplies, so you're ready for the child!</p>

          <div className="flex flex-row justify-center max-w-[700px] flex-wrap">
            <CheckboxCard 
              title="Begin Box"
          ...
          <p className="font-semibold text-[14px] leading-[19px] text-[#666666] py-[10px]">Expect a call from us to confirm the order details!</p>
