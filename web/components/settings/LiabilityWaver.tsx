...
//   function deleteWaiver(rank: number) {
//     if (liabilityWavers) {
//       const tempLiabilityWavers = liabilityWavers;
//       tempLiabilityWavers.splice(rank, 1);
//       setLiabilityWavers([...tempLiabilityWavers]);
//     }
//   }
...
export default function LiabilityWaver(props: {
  ...
  // useEffect(() => {
  //   const unsub = onSnapshot(doc(db, "app", "settings", "waivers"), (doc) => {
  //     setName(doc.name);
  //     setWaiver(doc.data()?.content);
  //   });
  ...
  // function setInfo() {
  //   //const waiverDoc = doc(db, "app", "settings", "waivers");
  //   addDoc(collection(db, "app", "settings", "waivers"), {content: waiver, name: name })
  //   alert("updated info");
  // }
  ...
  return (
    <div>
        ...
        <div className="grid grid-rows-1 grid-cols-10 gap-4 pb-6">
          ...
          <div>
            <div className="flex ml-12">
              <div
                style={{ width: "50px", height: "22px", marginBottom: "40px" }}
              >
                <p style={{ marginBottom: "100px" }}>Name: </p>
              </div>
              <div>
            ...
            <div className="col-span-7 ml-12 w-4/5">
              <MdEditor
      ...
      <div className="grid grid-rows-1 grid-cols gap-4">
        {/* <h2
          className="text-md mt-5 mb-5 font-bold text-red cursor-pointer"
          // onClick={() => {
          //   setUrls([...urls, ""]);
          // }}
        > */}
        ...
        {/* </h2> */}
        <div className="pt-3 col-start-8">
          <button
            className="flex-shrink-0 bg-white-500 hover:bg-blue-700 border-blue-500 hover:border-blue-700 text-sm border-2 text-blue-500 hover:text-white font-bold py-1 px-2 h-10 rounded"
            type="submit"
            // onClick={setInfo}
