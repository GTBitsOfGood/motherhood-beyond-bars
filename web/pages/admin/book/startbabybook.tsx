        ...
        <div className="flex flex-col w-full h-full items-center">
            ...
            <div className="flex flex-col w-full h-1/2 mt-7 pl-5 pr-5">
                ...
                <div className="text-base font-normal mt-7 mb-7">
                    The Baby Book is a place where you can document the baby’s journey by uploading images and descriptions. 
                    Motherhood Behind Bars will then deliver the images to the mothers, so they can stay updated on their baby’s growth.
                </div>
                <Button
                    text="Get Started"
                ></Button>
